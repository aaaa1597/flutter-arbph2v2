                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Table(
                              ...
                              children: [TableRow(children: [Padding(padding: EdgeInsets.all(4.0),child: Text(""))        ,Padding(padding: EdgeInsets.all(4.0),child: Text("着金")),Padding(padding: EdgeInsets.all(4.0),child: Text("送金[USDT]"))         ,Padding(padding: EdgeInsets.all(4.0),child: Text("送金[BTC]"))   ,Padding(padding: EdgeInsets.all(4.0),child: Text("送金[ETH]"))   ,Padding(padding: EdgeInsets.all(4.0),child: Text("送金[XRP]")),Padding(padding: EdgeInsets.all(4.0),child: Text("送金[BNB]"))    ,Padding(padding: EdgeInsets.all(4.0),child: Text("買い[%]")),Padding(padding: EdgeInsets.all(4.0),child: Text("売り[%]")),]),
