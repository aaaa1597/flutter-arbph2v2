    ...
    return Table(
      ...
      children: [
        ...
        TableRow(children: [Padding(padding: EdgeInsets.all(4.0),child: SelectableText("Bittrex")) ,Padding(padding: EdgeInsets.all(4.0),child: SelectableText(AskBidsbt.when(data: (ret) => ret[Symbol.BTC_USDT].bidstr, loading: () => '...', error: (e, stack) => '---')))
                                                                                         ...
                                                                                         ,Padding(padding: EdgeInsets.all(4.0),child: SelectableText(AskBidsbt.when(data: (ret) => ret[Symbol.BNB_USDT].bidstr, loading: () => '...', error: (e, stack) => '---')))
                                                                                         ,Padding(padding: EdgeInsets.all(4.0),child: SelectableText(AskBidsbt.when(data: (ret) => ret[Symbol.BNB_USDT].askstr, loading: () => '...', error: (e, stack) => '---'))),]),
        /******************************************/
        TableRow(children: [Padding(padding: EdgeInsets.all(4.0),child: SelectableText("OKEx"))    ,Padding(padding: EdgeInsets.all(4.0),child: SelectableText(AskBidsex.when(data: (ret) => ret[Symbol.BTC_USDT].bidstr, loading: () => '...', error: (e, stack) => '---')))
                                                                                         ...
                                                                                         ,Padding(padding: EdgeInsets.all(4.0),child: SelectableText(AskBidsex.when(data: (ret) => ret[Symbol.BNB_USDT].bidstr, loading: () => '...', error: (e, stack) => '---')))
                                                                                         ,Padding(padding: EdgeInsets.all(4.0),child: SelectableText(AskBidsex.when(data: (ret) => ret[Symbol.BNB_USDT].askstr, loading: () => '...', error: (e, stack) => '---'))),]),
        /******************************************/
        TableRow(children: [Padding(padding: EdgeInsets.all(4.0),child: SelectableText("Liquid"))  ,Padding(padding: EdgeInsets.all(4.0),child: SelectableText(AskBidslq.when(data: (ret) => ret[Symbol.BTC_USDT].bidstr, loading: () => '...', error: (e, stack) => '---')))
                                                                                         ...
                                                                                         ,Padding(padding: EdgeInsets.all(4.0),child: SelectableText(AskBidslq.when(data: (ret) => ret[Symbol.XRP_USDT].bidstr, loading: () => '...', error: (e, stack) => '---')))
                                                                                         ,Padding(padding: EdgeInsets.all(4.0),child: SelectableText(AskBidslq.when(data: (ret) => ret[Symbol.XRP_USDT].askstr, loading: () => '...', error: (e, stack) => '---')))
                                                                                         ,Padding(padding: EdgeInsets.all(4.0),child: SelectableText(AskBidslq.when(data: (ret) => ret[Symbol.BNB_USDT].bidstr, loading: () => '...', error: (e, stack) => '---')))
                                                                                         ,Padding(padding: EdgeInsets.all(4.0),child: SelectableText(AskBidslq.when(data: (ret) => ret[Symbol.BNB_USDT].askstr, loading: () => '...', error: (e, stack) => '---'))),]),
    ],);
  }
}